...
$("#kathryn").on("mouseover", function() {
    $("#kathryn").text("Kathryn");
    $("#kathryn").removeClass("no-right-border");
    $("#kathryn").addClass("border");
    $("#herod").hide();

    $("#kathryn").on("mouseleave", function() {
        $("#kathryn").text("K");
        $("#kathryn").addClass("border", "no-right-border");
        $("#herod").show();
...
$("#herod").on("mouseover", function() {
    $("#herod").text("Herod");
    $("#kathryn").hide();

    $("#herod").on("mouseleave", function() {
        $("#herod").text("He");
        $("#herod").addClass("border");
        $("#kathryn").show();
